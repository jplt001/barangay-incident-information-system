    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('residents.postcreate') }}" method="post" class="needs-validation @if($errors->any()) was-validated @endif" novalidate>
                        @csrf
                        {{--  Basic Information  --}}
                        ...
                        <div class="form-row mb-3">
                            ...
                            <div class="form-group col-md-6 fill">
                                ...
                                <input type="text" name="contact_number" id="contact_number" class="form-control" value="{{ old('contact_number') }}" required autocomplete="mobile">
                        ...
                        <div class="form-group text-center">
                            <button class="btn btn-outline-primary has-ripple">{{ __('Create Resident') }}</button>
                        </div>
                    </form>
                </div>
            </div>
