<x-guest-layout>
    <x-auth-card>
        ...
        <form action="{{ route('register') }}" method="post">
            ...
            <x-auth-text-input type="text" id="middle_name" name="middle_name" label="Middle" floatinglabel=true />
            <x-auth-text-input type="text" id="last_name" name="last_name" label="Last Name" required floatinglabel=true />
            <x-auth-text-input type="email" id="email" name="email" label="Email address" autocomplete="off"  required floatinglabel=true />
